    ...
    function commonService(){
      ...
      function getPredefinedDiscounts(){
        var predefinedGroups = [
          { label:'Descuento predefinido 1', discount:0, discountPercent:10 },
          { label:'Descuento predefinido 2', discount:0, discountPercent:20 },
          { label:'Descuento predefinido 3', discount:0, discountPercent:30 },
          { label:'Descuento predefinido 4', discount:0, discountPercent:40 },
          { label:'Descuento predefinido 5', discount:0, discountPercent:50 },
