  ...
  function userService($http, $q, api) {
    ...
    function getAllModules() {
      var modules = [
        ...
        {
          key: 'close-quotations',
          label: 'Cerrar cotizaciones',
          section: 'quotations',
        },
        {
          key: 'list-products',
        ...
        {
          key: 'config-sites',
          label: 'Lista de configuración de sitios',
          section: 'config',
        },
        {
          key: 'config-sites-edit',
          label: 'Configuración de sitio',
          section: 'config',
        },
        {
          key: 'config-delivery',
          label: 'Configuración de envios',
          section: 'config',
        },
        {
          key: 'ewallet-reports',
        ...
        {
          key: 'spotlight-marketing',
          label: 'Productos destacados',
          section: 'marketing',
        },
        {
          key: 'slowmovement-marketing',
          label: 'Productos de lento movimiento',
          section: 'marketing',
        },
        {
          key: 'create-marketing',
        ...
        {
          key: 'create-paymentmethods',
          label: 'Crear vigencias de metodos de pago',
          section: 'paymentmethods',
        },
        {
          key: 'edit-paymentmethods',
          label: 'Editar vigencias de metodos de pago',
          section: 'paymentmethods',
        },
        {
          key: 'list-paymentmethods',
          label: 'Ver vigencias de metodos de pago',
          section: 'paymentmethods',
        },

        {
          key: 'create-users-web',
          label: 'Crear usuarios web',
          section: 'usersweb',
        },
        {
          key: 'edit-users-web',
          label: 'Editar usuarios web',
          section: 'usersweb',
        },
        {
          key: 'list-users-web',
          label: 'Ver usuarios web',
          section: 'usersweb',
        },
      ];
      return modules;
